 ...
 *  wkcglpeer.h
 *
 *  Copyright(c) 2009-2013 ACCESS CO., LTD. All rights reserved.
 */
...
typedef signed long int wkcGLintptr;
typedef signed long int wkcGLsizeiptr;
...
/** @brief Type definitions of wkcContextLostProc */
typedef void(*wkcContextLostProc)(void*);
...
/**
@brief Register context lost callback
@param in_context context
@param in_proc callback
@param in_opaque opaque value for callback
@details
Register callbackthat should be called when peer context would be deleted by HW.
*/
WKC_PEER_API void wkcGLSetContextLostProcPeer(void* in_context, wkcContextLostProc in_proc, void* in_opaque);
...
WKC_PEER_API void wkcGLUniform2fPeer(void* in_context, wkcGLint location, wkcGLfloat x, float y);
