...
typedef enum _cairo_surface_type {
    ...
    ,
    /* The integer size of type cairo_surface_type_t must be equal to
       or greater than that of type cairo_internal_surface_type_t
       because each value of enum _cairo_internal_surface_type is set to
       variables of type cairo_surface_type_t. */
    CAIRO_SURFACE_TYPE_DUMMY_TYPESIZE_ADJUSTMENT = 0x7fffffff
#endif
} cairo_surface_type_t;
...
cairo_public void
cairo_image_surface_swap_data (cairo_surface_t *surface, unsigned char * data);
#endif
