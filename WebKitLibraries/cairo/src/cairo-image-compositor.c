 ...
 * Copyright (C) 2012, 2013 ACCESS Co., Ltd.
 *
...
#ifdef __ghs__
    uint8_t _buf[1]; // Our compiler doesn't support zero length array.
#define SZ_BUF (int)(sizeof (cairo_abstract_span_renderer_t) - (sizeof (cairo_image_span_renderer_t) - sizeof (uint8_t)))
#else
    uint8_t _buf[0];
