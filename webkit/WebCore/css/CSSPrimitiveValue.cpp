...
#if PLATFORM(WKC)
        WKC_DEFINE_STATIC_PTR(AtomicString*, keywordStrings, new AtomicString[numCSSValueKeywords]);
#else
...
#if PLATFORM(WKC)
        WKC_DEFINE_STATIC_PTR(AtomicString*, propertyStrings, new AtomicString[numCSSProperties]);
#else
...
// Definitions are moved to CSSPrimitiveValue.h
#else
