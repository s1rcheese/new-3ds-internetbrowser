...
#if PLATFORM(WKC)
WKC_DEFINE_GLOBAL_PTR(RuleSet*, defaultStyle, 0);
WKC_DEFINE_GLOBAL_PTR(RuleSet*, defaultQuirksStyle, 0);
WKC_DEFINE_GLOBAL_PTR(RuleSet*, defaultPrintStyle, 0);
WKC_DEFINE_GLOBAL_PTR(RuleSet*, defaultViewSourceStyle, 0);
WKC_DEFINE_GLOBAL_PTR(StyleSheetInternal*, simpleDefaultStyleSheet, 0);
WKC_DEFINE_GLOBAL_PTR(StyleSheetInternal*, defaultStyleSheet, 0);
WKC_DEFINE_GLOBAL_PTR(StyleSheetInternal*, quirksStyleSheet, 0);
WKC_DEFINE_GLOBAL_PTR(StyleSheetInternal*, svgStyleSheet, 0);
WKC_DEFINE_GLOBAL_PTR(StyleSheetInternal*, mathMLStyleSheet, 0);
WKC_DEFINE_GLOBAL_PTR(StyleSheetInternal*, mediaControlsStyleSheet, 0);
WKC_DEFINE_GLOBAL_PTR(StyleSheetInternal*, fullscreenStyleSheet, 0);

WKC_DEFINE_GLOBAL_CLASS_OBJ(RenderStyle*, StyleResolver, s_styleNotYetAvailable, 0);
#else
...
#if PLATFORM(WKC)
        WKC_DEFINE_STATIC_PTR(StyleKeyframe*, zeroPercentKeyframe, 0);
#else
...
#if PLATFORM(WKC)
        WKC_DEFINE_STATIC_PTR(StyleKeyframe*, hundredPercentKeyframe, 0);
#else
