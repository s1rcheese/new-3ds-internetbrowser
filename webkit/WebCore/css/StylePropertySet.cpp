...
void StylePropertySet::appendFontLonghandValueIfExplicit(CSSPropertyID propertyId, StringBuilder& result) const
{
...
String StylePropertySet::fontValue() const
{
    ...
    const CSSProperty* fontFamilyProperty = findPropertyWithId(CSSPropertyFontFamily);
    if (!fontSizeProperty || !fontFamilyProperty)
        return emptyString();
    ...
    appendFontLonghandValueIfExplicit(CSSPropertyFontStyle, result);
    appendFontLonghandValueIfExplicit(CSSPropertyFontVariant, result);
    appendFontLonghandValueIfExplicit(CSSPropertyFontWeight, result);
    if (!result.isEmpty())
        result.append(' ');
    result.append(fontSizeProperty->value()->cssText());
    appendFontLonghandValueIfExplicit(CSSPropertyLineHeight, result);
    if (!result.isEmpty())
        result.append(' ');
