...
#if PLATFORM(WKC)
WKC_DEFINE_GLOBAL_CLASS_OBJ(bool, RenderObject, s_affectsParentBlock, false);

WKC_DEFINE_GLOBAL_CLASS_OBJ(RenderObjectAncestorLineboxDirtySet*, RenderObject, s_ancestorLineboxDirtySet, 0);
#else
...
bool RenderObject::isSelectionBorder() const
{
    ...
    return st == SelectionStart
        || st == SelectionEnd
        || st == SelectionBoth
        || (view() && view()->selectionStart() == this)
        || (view() && view()->selectionEnd() == this);
}
