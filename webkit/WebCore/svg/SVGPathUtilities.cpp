...
{
#if PLATFORM(WKC)
    WKC_DEFINE_STATIC_PTR(SVGPathBuilder*, s_builder, 0);
#else
...
{
#if PLATFORM(WKC)
    WKC_DEFINE_STATIC_PTR(SVGPathSegListBuilder*, s_builder, 0);
#else
...
{
#if PLATFORM(WKC)
    WKC_DEFINE_STATIC_PTR(SVGPathByteStreamBuilder*, s_builder, 0);
#else
...
{
#if PLATFORM(WKC)
    WKC_DEFINE_STATIC_PTR(SVGPathStringBuilder*, s_builder, 0);
#else
...
{
#if PLATFORM(WKC)
    WKC_DEFINE_STATIC_PTR(SVGPathTraversalStateBuilder*, s_builder, 0);
#else
...
{
#if PLATFORM(WKC)
    WKC_DEFINE_STATIC_PTR(SVGPathParser*, s_parser, 0);
#else
...
{
#if PLATFORM(WKC)
    WKC_DEFINE_STATIC_PTR(SVGPathBlender*, s_blender, 0);
#else
