...
#if PLATFORM(WKC)
    FontPlatformData(const FontDescription&, const char* family);
#endif
...
#endif
#if PLATFORM(WKC)
    WKC::WKCFontInfo* font() const { return (isHashTableDeletedValue() ? 0 : m_font); }
#endif
...
#endif
#if PLATFORM(WKC)
    static WKC::WKCFontInfo* hashTableDeletedFontValue() { return reinterpret_cast<WKC::WKCFontInfo*>(-1); }
#endif
