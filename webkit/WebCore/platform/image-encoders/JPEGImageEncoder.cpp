...
bool compressRGBABigEndianToJPEG(unsigned char* rgbaBigEndianData, const IntSize& size, Vector<char>& jpegData, int quality)
{
...
#if PLATFORM(WKC)
    jpeg_set_quality(&compressData, quality, FALSE);
#else
