...
#if PLATFORM(WKC)
WKC_DEFINE_GLOBAL_PTR(const XMLHttpRequestStaticData*, staticData, 0);
#else
...
static const XMLHttpRequestStaticData* initializeXMLHttpRequestStaticData()
{
    ...
    WKC_DEFINE_STATIC_PTR(const XMLHttpRequestStaticData*, dummy, createXMLHttpRequestStaticData());
...
#if PLATFORM(CHROMIUM) || PLATFORM(BLACKBERRY) || PLATFORM(WKC)
